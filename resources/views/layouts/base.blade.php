                            ...
                            <a href="{{ route('municipality') }}" class="menu-link">
                                        ...
                                        <!-- Generator: Adobe Illustrator 19.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                                     ...
                                                     style="enable-background:new 0 0 511.974 511.974;"
                                                     xml:space="preserve">
            ...
            <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div class="configuration mb-4">
                    <div class="btn-group  float-right mx-4">
                        ...
                        <a class="btn btn-link btn-warning btn-sm mr-4"
                           href="{{ route('provinces.province.index') }}">
                            <i class="fa fa-cog"></i>
                            Province List</a>
                        <a class="btn btn-link btn-success btn-sm mr-4" href="{{ route('barangays.barangay.index') }}">
                            <i class="fa fa-cog"></i>
                            Brangay List</a>
                        <a class="btn btn-link btn-primary btn-sm"
                           href="{{ route('cities.city.index') }}">
                            <i class="fa fa-cog"></i>
                            City List</a>
                    </div>
                </div>
